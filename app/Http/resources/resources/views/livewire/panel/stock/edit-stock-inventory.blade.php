        ...
        <div class="mx-auto max-w-screen-2xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="md:flex md:items-center md:justify-between">
                <div class="min-w-0 flex-1">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900">Agregar mas Unidades de inventario a  {{ $product->name }}</h1>
                </div>
            ...
            <div class="mt-8 flow-root">
                <div class="space-y-10 divide-y divide-gray-900/10">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-4">
                        ...
                        {{-- <div class="px-4 sm:px-0 pt-">
                            <span class="text-sm text-gray-500">Cantidad de unidades asociadas: {{ $unitsCount }}</span>
                        </div> --}}
                                ...
                                <div class="grid w-full grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-9">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="quantity"
                                            ...
                                            unidades que asociaras</label>
                                        <div class="mt-2">
                                            <input placeholder="Define la cantidad de unidades" wire:model="quantity" type="number" name="quantity"
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input placeholder="Ingresa el lote del producto" wire:model="batch" id="batch" name="batch" type="text"
                                                autocomplete="batch"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        @error('batch')
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input placeholder="Ingresa el costo" wire:model="cost" type="number" name="cost" id="cost"
                                                autocomplete="cost"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        @error('cost')
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="profit"
                                            ...
                                            estimada</label>
                                        <div class="mt-2">
                                            <input  placeholder="Ingresa la ganancia estimada" wire:model="profit" type="number" name="profit" id="profit"
                                                autocomplete="profit"
                                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                        @error('profit')

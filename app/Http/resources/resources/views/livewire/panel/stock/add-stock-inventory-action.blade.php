    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-screen-2xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="md:flex md:items-center md:justify-between">
                <div class="min-w-0 inline">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900">Gestiona gestiona tu unidad <span class="text-base font-bold">{{ $unit->tag }}-{{ $product->name }}</span>
                    </h1>
                </div>
                ...
                <div class="space-y-10 divide-y divide-gray-900/10">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-4">
                        ...
                        <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-3">
                                    ...
                                    @if ($actionType)
                                        @if ($actionType == 'low')
                                            <div class="sm:col-span-3">
                                                ...
                                                @error('destinationableSelected.id')
                                                    <span class="text-red-500 text-sm ml-0.5">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="sm:col-span-full">
                                                ...
                                                <div class="mt-2">
                                                    <textarea x-data="{
                                                        ...
                                                        placeholder="¿Porque vas a realizar esta baja de unidad?."
                                        ...
                                        @elseif($actionType == 'transfer_to_warehouse')
                                            <div class="sm:col-span-3">
                                            ...
                                            <div class="sm:col-span-full">
                                                ...
                                                <div class="mt-2">
                                                    <textarea x-data="{
                                                        ...
                                                        name="reason_description" type="text"
                                                        placeholder="¿Porque motivo se transferiran unidades al deposito?"
                                                        class="flex w-full h-auto min-h-[80px] max-h-[130px] px-3 py-2 text-sm bg-white border rounded-md border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:cursor-not-allowed disabled:opacity-50"></textarea>
                                                </div>
                                                @error('quantity')
                                                    <span class="text-red-500 text-sm ml-0.5">{{ $message }}</span>
                                        ...
                                        @elseif($actionType == 'transfer_to_worker')
                                            <div class="sm:col-span-3">
                                            ...
                                            <div class="sm:col-span-full">
                                                ...
                                                <div class="mt-2">
                                                    <textarea x-data="{
                                                        ...
                                                        name="reason_description" type="text"
                                                        placeholder="¿Porque motivo se transferira la unidad al operario?"
                                                        class="flex w-full h-auto min-h-[80px] max-h-[130px] px-3 py-2 text-sm bg-white border rounded-md border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:cursor-not-allowed disabled:opacity-50"></textarea>
                                                </div>
                                                @error('quantity')
                                                    <span class="text-red-500 text-sm ml-0.5">{{ $message }}</span>
                                        ...
                                        @elseif($actionType == 'transfer_to_other_unit')
                                            <div class="sm:col-span-3">
                                                <label for="selected-worker"
                                                    class="block text-sm font-medium leading-6 text-gray-900">Selecciona
                                            ...
                                            <div class="sm:col-span-full">
                                                ...
                                                <div class="mt-2">
                                                    <textarea x-data="{
                                                      ...
                                                      name="reason_description" type="text"
                                                        placeholder="¿Porque motivo se transferir una cantidad de una unidad a otra?"
                                                        class="flex w-full h-auto min-h-[80px] max-h-[130px] px-3 py-2 text-sm bg-white border rounded-md border-neutral-300 ring-offset-background placeholder:text-neutral-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:cursor-not-allowed disabled:opacity-50"></textarea>
                                                </div>
                                                @error('quantity')
                                                    <span class="text-red-500 text-sm ml-0.5">{{ $message }}</span>
                                                                    ...
                                                                    <div class="bg-gray-50 rounded-md p-4 space-y-2">
                                                                        ...
                                                                        <div class="flex justify-between">
                                                                            <span
                                                                                ...
                                                                                actual:</span>
                                                                            <span
                                                                                class="text-sm text-gray-900">{{ $current_emisor_quantity }}
                                                                        ...
                                                                        <div class="flex justify-between">
                                                                            <span
                                                                                ...
                                                                                final:</span>
                                                                            <span
                                                                                class="text-sm font-semibold text-gray-900">{{ $final_emisor_quantity ?? $current_emisor_quantity }}
                                                                                {{ UnitMeditionTypeEnum::from($this->product_unit_measure)->abbreviation() }}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="bg-gray-50 rounded-md p-4 space-y-2">
                                                                        <div class="flex justify-between">
                                                                            <span
                                                                                ...
                                                                                actual:</span>
                                                                            <span
                                                                                class="text-sm text-gray-900">{{ $current_receptor_quantity }}
                                                                        ...
                                                                        <div class="flex justify-between">
                                                                            <span
                                                                                ...
                                                                                final:</span>
                                                                            <span
                                                                                class="text-sm font-semibold text-gray-900">{{ $final_receptor_quantity ?? $current_receptor_quantity }}
                                                                                {{ UnitMeditionTypeEnum::from($selectedUnit['unit_of_measurement'])->abbreviation() }}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            @elseif ($actionType == 'transfer_to_warehouse' || $actionType == 'transfer_to_worker' || ($actionType == 'transfer_to_other_unit' ))
                                <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                                    <button wire:click="save"

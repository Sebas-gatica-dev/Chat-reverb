                ...
                @can('access-function', 'customer-add')
                    <div class=" items-center sm:flex md:ml-4 md:mt-0 justify-end">
                        ...
                        <a wire:navigate href="{{ route('panel.customers.add') }}"
                            class="ml-3 inline-flex items-center rounded-md bg-gradient-to-t from-violet-800 to-purple-700 hover:from-purple-600 hover:to-purple-700 px-2 py-1.5 sm:px-3 sm:py-2 text-[0.8em] sm:text-sm font-semibold text-white shadow-sm hover:bg- focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Agregar
                            cliente</a>
                    </div>
                @endcan
            </div>

        ...
        <div class="mx-auto max-w-screen-2xl px-4 py-6 sm:px-6 lg:px-8">
            <div class="md:flex md:items-center md:justify-between">
                <div class="min-w-0 flex-1">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900">Agregar Ticket</h1>
                </div>
                            ...
                            <div class="px-4 py-6 sm:p-8">
                                <div class="grid w-full grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-9">
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input type="date" wire:model="date" id="date" autocomplete="off"
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input type="number" wire:model="amount" id="amount" autocomplete="off"
                                    ...
                                    <div class="sm:col-span-3"
                                        ...
                                        <livewire:components.upload-file :multiple="false" :types="['image']" :name="'proof'" />
                                        @error('proof')
                                            <span class="text-red-500 text-sm ml-0.5">{{ $message }}</span>
                                        @enderror

<div>
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 -mx-4 sm:mx-0 px-6 pb-6 pt-4 rounded-b-lg">
            ...
            <livewire:components.upload-file :multiple="true" :types="['image','video','audio','document']" :showPreview="false" :name="'user-files'">

            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                {{-- @dd(array_column($files->toArray(), 'type')) --}}
               {{-- @dd($files[1]['type']) --}}
                @forelse($files->toArray() as $file)
                    <div class="relative group content-center">
                        ...
                        <div
                            ...
                            <!-- Foto de usuario -->
                            <img class="w-6 h-6 rounded-full mr-2" src="{{ $file['path'] }}"
                                alt="{{ $user->name }}">
                ...
                @empty
                        ...
                        <div class="rounded-md bg-yellow-50 p-4 relative group content-center col-span-full">
                            <div class="text-sm font-medium text-yellow-700 text-center">
                                <p>Todavía no se han registrado archivos para este usuario.</p>
                            </div>
                        </div>

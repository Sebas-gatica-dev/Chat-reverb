<div x-data="{}">
    <div class="rounded-md bg-blue-50 p-4 mt-4">
        <div class="flex">
            ...
            <div class="ml-3 flex-1 md:flex md:justify-between">
                <p class="text-sm text-blue-700">¿Llegaste al cliente? Apenas confirmes se le avisará al cliente que
                    estás en la puerta.</p>
            </div>
        </div>
    </div>
    ...
    @if ($bigDelay)
        <div class="rounded-md bg-yellow-50 p-4 mt-4">
            <div class="flex">
                ...
                <div class="ml-3 flex-1 md:flex md:justify-between">
                    <p class="text-sm text-yellow-700">¡Esta visita estába pactada para ser realizada hace {{ $this->visitDateDiference }}!.  </p>
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="col-span-full mt-6">
        ...
        <div class="sm:col-span-4 my-4">
            <label for="textarea" class="block text-sm font-medium leading-6 text-red-600">Deja aqui el motivo de tu retraso.</label>
            <div class="mt-2">
                <textarea id="textarea" wire:model="reasonDelay" rows="3"
                    placeholder="¿Quieres dejar un motivo de tu retraso?"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-400 text-sm sm:leading-6"></textarea>
            </div>

    <div class="flex items-center px-6  md:mx-auto md:max-w-3xl lg:mx-0 lg:max-w-none xl:px-0 mt-[0.875rem]">
        <div class="w-full hidden lg:block">
            ...
            <div class="relative">
                ...
                <input id="search" wire:model="search"
                    wire:keydown.enter="searching" wire:keydown.escape="reset"

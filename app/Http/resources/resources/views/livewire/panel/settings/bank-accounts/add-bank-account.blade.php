            ...
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        ...
                        <p class="mt-2 text-sm text-gray-700">Registra una nueva cuenta para tu negocio</p>
                    </div>
                ...
                <div class="mt-8 flow-root">
                    <x-panel.settings.form>
                        <x-slot name="slot">
                            ...
                            <div class="lg:col-span-3 col-span-full">
                                <label for="branches" class="block text-sm font-medium leading-6 text-gray-900">Selecciona sucursales para tu cuenta</label>
                                <div class="mt-2">
                            ...
                            <div class="col-span-full">
                                ...
                                <livewire:components.upload-file :multiple="true" :types="['image', 'document']" :name="'bank-account-files'" />
                            </div>
                        </x-slot>
                        <x-slot name="buttons">
                            ...
                            <button wire:click="save('save-new')" wire:loading.attr="disabled"
                                class="rounded-md bg-indigo-600 px-3 py-2 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 text-sm focus-visible:outline-indigo-600">
                                Crear y crear otra
                            </button>
                        </x-slot>

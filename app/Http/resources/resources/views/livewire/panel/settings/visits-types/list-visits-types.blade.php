            ...
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                ...
                <div class="sm:flex sm:items-center" x-data="{ open: false }">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Tipos de visitas</h1>
                        <p class="mt-2 text-sm text-gray-700">Administra los tipos de visitas que se pueden realizar en
                            las propiedades.
                        </p>
                    </div>
                    @can('access-function', 'visit-type-add')
                    ...
                    <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true"
                        ...
                        wire:keydown.enter="createVisitType">
                                ...
                                <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6"
                                    ...
                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <h3 class="text-base font-semibold leading-6 text-gray-900 mb-4"
                                            id="modal-title">Agregar tipo de visita</h3>
                                        <div class="col-span-full">
                                            ...
                                            <div class="mt-2">
                                                <input type="text" wire:model="name" name="name" id="name"
                                                    autocomplete="off"
                                                    placeholder="Escriba un nombre para el tipo de visita"
                                    ...
                                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                        <button type="button" wire:click="createVisitType"
                ...
                <div class="mt-8 flow-root" x-data="{ open: false }">
                    <div
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="relative py-3.5 text-right font-semibold pl-3 pr-16">
                                            ...
                                            <svg wire:loading.inline wire:target="restoreVisitType, forceDeleteVisitType, deleteVisitType" class="absolute right-1 hidden animate-spin mx-4 h-5 w-5 text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        ...
                                        <div wire:key="{{ $type->id }}">
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    @if ($type->deleted_at)
                                                    @can('access-function', 'visit-type-delete')
                                                        <button wire:click="forceDeleteVisitType('{{ $type->id }}')"
                                                            wire:confirm="¿Estás seguro de que deseas eliminar definitivamente este tipo de visita?"
                                                            class="text-red-600 hover:text-red-900 ml-4">Eliminar</button>
                                                    @endcan
                                                    @can('access-function', 'visit-type-restore')
                                                        <button wire:click="restoreVisitType('{{ $type->id }}')"
                                                            class="text-green-600 hover:text-green-900 ml-4">Activar</button>
                                                    @endcan
                                                    @else
                                                    @can('access-function', 'visit-type-edit')
                                                        <button wire:click="editModalVisitType('{{ $type->id }}')"
                                                            class="text-indigo-600 hover:text-indigo-900">Editar<span
                                                                class="sr-only">{{ $type->name }}</span></button>
                                                    @endcan
                                                    @can('access-function', 'visit-type-soft')
                                                        <button wire:click="deleteVisitType('{{ $type->id }}')"
                                    ...
                                    @empty
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500">
                                                No hay tipos de visitas registrados.
                                            </td>
                                        </tr>
                                    @endforelse
                        ...
                        <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true"
                            ...
                            x-on:open-edit-modal.window="open = true" wire:keydown.enter="updateVisitType"
                            ...
                            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                                <div
                                    ...
                                    <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6"
                                        ...
                                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            <h3 class="text-base font-semibold leading-6 text-gray-900 mb-4"
                                                id="modal-title">Editar tipo de visita</h3>
                                            <div class="col-span-full">
                                                <label for="editName"
                                                    class="block text-sm font-medium leading-6 text-gray-900">Nombre</label>
                                                <div class="mt-2">
                                        ...
                                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                            <button type="button" wire:click="updateVisitType"
                    ...
                    {{ $visitsTypes->links(data: ['scrollTo' => false]) }}

            ...
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                ...
                <div class="sm:flex sm:items-center" x-data="{ open: false }">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Plantillas de estadísticas</h1>
                        <p class="mt-2 text-sm text-gray-700">Administra las estadísticas visibles para cada usuario o
                            grupo de usuarios según su rol.
                        </p>
                    </div>

                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <a href="{{ route('panel.settings.stats.create') }}" wire:navigate
                                                ...
                                                <td
                                                    ...
                                                    @if ($template->deleted_at)
                                                        @can('access-function', 'service-delete')
                                                            <button wire:click="forceDeleteService('{{ $template->id }}')"
                                                        ...
                                                        @can('access-function', 'service-restore')
                                                            <button wire:click="restoreService('{{ $template->id }}')"
                                                                class="text-green-600 hover:text-green-900 ml-4">Activar</button>
                                                        @endcan
                                                    @else
                                                        @can('access-function', 'service-edit')
                                                            <a href="{{ route('panel.settings.stats.edit', $template->id) }}" wire:navigate
                                                        ...
                                                        @can('access-function', 'service-soft')
                                                            <button wire:click="deleteService('{{ $template->id }}')"

            ...
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                ...
                <div class="sm:flex sm:items-center" x-data="{ open: false }">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Tipos de propiedades</h1>
                        <p class="mt-2 text-sm text-gray-700">Administra los tipos de propiedades que se pueden registrar
                            en la plataforma.
                        </p>
                    </div>
                    @can('access-function','property-type-add')
                    ...
                    <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true"
                        ...
                        wire:keydown.enter="createPropertyType">
                                ...
                                <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6"
                                    ...
                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        <h3 class="text-base font-semibold leading-6 text-gray-900 mb-4"
                                            id="modal-title">Agregar tipo de propiedad</h3>
                                    ...
                                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                        <button type="button" wire:click="createPropertyType"
                ...
                <div class="mt-8 flow-root" x-data="{ open: false }">
                    <div
                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-4">
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="relative py-3.5 text-right font-semibold pl-3 pr-16">
                                            ...
                                            <svg wire:loading.inline wire:target="restorePropertyType, forceDeletePropertyType, deletePropertyType" class="absolute right-1 hidden animate-spin mx-4 h-5 w-5 text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse ($propertiesTypes as $type)
                                        <div wire:key="{{ $type->id }}">
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    @if ($type->deleted_at)
                                                    @can('access-function','property-type-delete')
                                                        <button wire:click="forceDeletePropertyType('{{ $type->id }}')"
                                                    ...
                                                    @endcan
                                                    @can('access-function','property-type-restore')
                                                        <button wire:click="restorePropertyType('{{ $type->id }}')"
                                                            class="text-green-600 hover:text-green-900 ml-4">Activar</button>
                                                    @endcan        
                                                    @else
                                                        @can('access-function','property-type-edit')
                                                            <button wire:click="editModalPropertyType('{{ $type->id }}')"
                                                                class="text-indigo-600 hover:text-indigo-900">Editar<span
                                                                    class="sr-only">{{ $type->name }}</span></button>
                                                        @endcan
                                                        @can('access-function','property-type-soft')        
                                                            <button wire:click="deletePropertyType('{{ $type->id }}')"
                        ...
                        <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true"
                            ...
                            x-on:open-edit-modal.window="open = true" wire:keydown.enter="updatePropertyType"
                            ...
                            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                                <div
                                    ...
                                    <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6"
                                        ...
                                        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                            <button type="button" wire:click="updatePropertyType"
                    ...
                    {{ $propertiesTypes->links(data: ['scrollTo' => false]) }}

<div>
    <div class="mx-auto max-w-screen-2xl pt-2 lg:flex lg:gap-x-16 lg:px-8">
        <h1 class="sr-only">Editar salario</h1>
        <aside
            ...
            <div class="mx-auto max-w-2xl space-y-4 sm:space-y-4 lg:mx-0 lg:max-w-none">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Editar salario</h1>
                        <p class="mt-2 text-sm text-gray-700">Vas a poder editar detalladamente la ganancia del mes del trabajador.</p>
                    </div>

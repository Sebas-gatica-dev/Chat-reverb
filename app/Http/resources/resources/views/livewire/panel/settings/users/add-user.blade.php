        ...
        <main class="px-4 py-16 sm:px-6 lg:flex-auto lg:px-0 lg:py-20">
            <div class="mx-auto max-w-2xl space-y-4 sm:space-y-6 lg:mx-0 lg:max-w-none">
                ...
                <div class="grid grid-cols-1 gap-x-8 gap-y-3 pt-2">
                    ...
                    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl p-10">

                        <div class="grid w-full grid-cols-12 gap-x-6 gap-y-6 sm:grid-cols-12">
                            <div class="sm:col-span-3">
                                <label for="number" class="block text-sm font-medium leading-6 text-gray-900">Teléfono del cliente</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-3">
                                <label for="tagNumber" class="block text-sm font-medium leading-6 text-gray-900">Etiqueta del contacto</label>
                                <div class="mt-2">
                ...
                <div class="grid grid-cols-1 gap-x-8 gap-y-3 pt-2">
                    ...
                    <livewire:components.maps.google-map-form-field-component :selectField="true" :selectElements="$branches" :input_id="'address'" 

...
new class extends Component {
    ...
    public function mount()
    {
        ...
        $this->routes = [
            ...
            [
                'name' => 'Pagos',
                'route' => route('panel.payments.list'),
            ...
            [
                'name' => 'Tickets',
                'route' => route('panel.tickets.list'),
                'active' => 'panel.tickets.*',
                'gate' => true,
            ],
                    ...
                    <div class="relative ml-5 flex-shrink-0" x-data="{ open: false }">
                        ...
                        <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            @can('access-function', 'settings-my-account')
                                <a wire:navigate href="{{ route('panel.users.show', auth()->user()) }}"
                ...
                <div class="flex items-center justify-between" @click="openProfile = !openProfile">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            ...
                            <img class="h-10 w-10 rounded-full" src="{{ auth()->user()->photo }}"
                                alt="{{ auth()->user()->name }}">
                        </div>
                        <div class="ml-3">

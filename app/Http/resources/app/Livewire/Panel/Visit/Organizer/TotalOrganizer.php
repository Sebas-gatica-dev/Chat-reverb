...
class TotalOrganizer extends Component
{
    ...
    public $contemplatedOrganizedVisits = true;
    ...
    public function initProcessOrganizations()
    {
        ...
        $job = new OrganizerVisits($finalMergedEmployees, $this->startDate, $this->endDate, $automaticRoute, $this->contemplatedOrganizedVisits);
    ...
    private function initialAutomaticRoute($mergedVisitIds)
    {
        $automaticRoute = AutomaticRoute::create([
            ...
            'contemplate_organizedvisit' => $this->contemplatedOrganizedVisits, // Booleano para contemplar visitas organizadas
    ...
    private function checkAvailability($availabilities, $operator)
    {
        ...
        foreach ($availabilities as $availability) {
            ...
            $visitStart = $availability->start_time;
            $visitEnd = $availability->end_time;
            ...
            if ($operatorAvailability) {
                ...
                if ($visitStart < $operatorAvailability->end_time && $visitEnd > $operatorAvailability->start_time) {

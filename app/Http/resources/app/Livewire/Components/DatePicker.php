...
class DatePicker extends Component
{
    ...
    public function getListeners()
    {
        ...
        return [
            $this->dateRangeEventName => 'dateRangeSelected',
        ];
    }
    ...
    public function mount()
    {
        ...
        $this->dateRangeEventName = 'dateRange' . $this->name;
    ...
    public function dateRangeSelected($start, $end)
    {
        ...
        if ($this->name) {
            // dump($this->name);
            $this->dispatch(sprintf('set-date-range-%s', $this->name), $start, $end);
        } else {

...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function products()
    {
        return $this->hasManyThrough(
            Product::class,
            Unit::class,
            'worker_id', // Foreign key on the units table...
            'id',        // Foreign key on the products table...
            'id',        // Local key on the users table...
            'product_id' // Local key on the units table...
        )->distinct();
    }
    ...
    {
        return $this->hasMany(Unit::class, 'worker_id');
    }
    ...
    public function unitsHistories()
    {
    ...
    {
        return $this->hasMany(RequestPayment::class, 'created_by');
    }

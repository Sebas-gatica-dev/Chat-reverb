...
class WithSubscription
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $activeSubscription = $business->subscriptionActive;

        // Si hay una suscripción activa, continuamos con la petición
        if ($activeSubscription) {

            if ($activeSubscription->status === SubscriptionStatus::GracePeriod) {

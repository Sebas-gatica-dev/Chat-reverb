...
class ShowOrganizerPreview extends Component
{
    ...
    public function recalculateTimesForAllVisits($date, $operatorId)
    {
        ...
        foreach ($visits as $index => &$visit) {
            ...
            $previousLat = $visit['latitud'];  // Actualiza la latitud de la visita para el próximo cálculo
    ...
    public function structureVisit($visit)
    {
        ...
        $visitArray = [
            'id' => $visit->id,
            'latitud' => $visit->property->latitude ?? null, // Se toma la latitud desde la propiedad

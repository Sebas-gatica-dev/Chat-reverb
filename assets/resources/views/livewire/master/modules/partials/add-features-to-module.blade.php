<div>
        <div class="col-span-3">
            <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Funciones</label>
            <div class="mt-2">
                    ...
                    <ul x-show="open"
                        ...
                        <li class="text-gray-900 cursor-default select-none py-2 pl-3 pr-4" id="listbox-option-0"
                            ...
                            <button wire:click.prevent="selectAllFeatures" class="w-full text-left">
                                <span class="font-normal block truncate text-sm text-gray-500">
                                    {{ count($selectedFeatures) === count($features) ? 'Deseleccionar todas' : 'Seleccionar todas' }}
                                </span>
                            </button>
                        </li>
                        @foreach ($features as $feature)
                            <li class="text-gray-900 text-sm relative cursor-default select-none py-2 pl-8 pr-4"
                                id="listbox-option-{{ intval($feature['id']) + 1 }}" role="option">
                                <button
                                    wire:click.prevent="toggleFeaturesSelected('{{ $feature['id'] }}', '{{ $feature['name'] }}')"
        ...
        <div class="col-span-3">
            <div class="mt-9 items-center">
                <button type="button" wire:click="addFeaturesToModule"

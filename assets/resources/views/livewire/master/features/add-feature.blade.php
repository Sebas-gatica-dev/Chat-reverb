<div>
    ...
    <div class="px-4 py-6 sm:p-8">
        <h1 class="sr-only">Creacion de funcion</h1>


        <div class="mt-2 sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-white">Crear funcion</h1>
                <p class="mt-2 text-sm text-gray-300">Llena el formulario para crear el funcion</p>
            </div>

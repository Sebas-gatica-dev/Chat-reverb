<div>
    ...
    <div class="px-4 py-6 sm:p-8">
        <h1 class="sr-only">Edicion de industria</h1>


        <div class="mt-2 sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-white">Edicion industria</h1>
                <p class="mt-2 text-sm text-gray-300">Llena el formulario para editar la industria {{ $industry->name }}</p>
            </div>
    ...
    <!-- Sección para asociar funciones a la industria -->

    <div class="grid w-full gap-x-6 gap-y-8 grid-cols-9 md:col-span-2 ring-1 ring-gray-900/5 sm:rounded-xl mt-6">
        <div class="col-span-full">
            <h2 class="text-base font-semibold leading-6 text-white">Asociar funciones a la industria</h2>
            <p class="mt-2 text-sm text-gray-300">Selecciona funciones.</p>
        </div>
        <div class="col-span-6">

            <livewire:master.features.partials.multi-select-features :industry="$industry">
                ...
                <div class="bg-gray-900 py-10">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            ...
                            <p class="mt-2 text-sm text-gray-300">Lista de funciones asociadas a la industria
                                {{ $industry->name }}</p>
                        </div>
                    </div>
                    <div class="mt-8 flow-root">
                        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                ...
                                <div x-show="selectedFeatures.length > 0" class="inline-flex items-center gap-2 px-3">
                                    ...
                                    <button @click="$wire.confirmDetachSelectedFeaturesForIndustry()" type="button"
                                    ...
                                    <tbody class="divide-y divide-gray-800">
                                        @forelse ($features as $feature)
                                            ...
                                            <tr wire:key="{{ $feature->id }}">
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-300">
                                                    {{ $feature->module->name ? $feature->module->name : 'Sin modulo' }}
                                                </td>
                                                ...
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-300">
                                                    <button wire:click="confirmDetachSelectFeatureForIndustry('{{ $feature->id }}')"

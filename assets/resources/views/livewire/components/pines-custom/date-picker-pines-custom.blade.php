<div class="sm:col-span-2">
    <div>
      <div class="sm:col-span-3">
        <label for="expiration_date" class="block text-sm font-medium leading-6 text-gray-900">Fecha de vencimiento</label>
        <div class="mt-0">
          
              <div x-data="{
                datePickerOpen: false,
                $wire.entangle(datePickerValue),
                ...
                datePickerDays: ['Dom', 'Lun', 'Mar', 'Mier', 'Jue', 'Vie', 'Sab'],
                  ...
                  <div class="w-full mb-5">
                      <div class="relative w-[17rem]">
                          ...
                          <div  
                              ...
                              class="absolute z-[10000] top-0 left-0 max-w-lg p-4 mt-12 antialiased bg-white border rounded-lg shadow w-[17rem] border-neutral-200/70">

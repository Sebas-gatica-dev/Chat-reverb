        ...
        <div class="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
            <div
                ...
                <div class="lg:col-start-3 lg:row-end-1">
                    ...
                    bg-white pl-3 pr-2 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            x-cloak x-ref="menu-items" x-description="Dropdown menu, show/hide based on menu state."
                            role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">

                            <div class="py-1" role="none">
                                <!-- Active: "bg-gray-100 text-gray-900", Not Active: "text-gray-700" -->
                                @can('access-function','property-add')
                                    <a wire:navigate href="{{ route('panel.customers.property.add', $customer->id) }}"
                                        class="group flex items-center px-4 py-2 text-sm text-gray-700" role="menuitem"
                                ...
                                @can('access-function','property-delete')
                                    <button wire:confirm= "Desea eliminar esta propiedad?" wire:click="deleteProperty"
                                        class="group flex items-center px-4 py-2 text-sm text-gray-700" role="menuitem"
                ...
                <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2 items-center justify-end hidden lg:flex"
                    ...
                    <div class="w-full grid grid-cols-1 grid-rows-1 gap-x-4 lg:grid-cols-4" x-show="openFilters"
                        ...
                        <livewire:components.select-general :selectedValue="$selectedVisitType" :values="$visitType" :imageValue="false"
                            :searchEnabled="false" :name="'visit-type'" :model="false">
                            <livewire:components.select-general :selectedValue="$selectedStatus" :values="$status" :imageValue="false"
                                :searchEnabled="false" :name="'status'" :model="false">
                                <livewire:components.select-general :selectedValue="$selectedUser" :values="$users"
                                    ...
                                    <livewire:components.select-general :selectedValue="$selectedService" :values="$services"
                                        :imageValue="false" :searchEnabled="false" :name="'service'" :model="false">
                    ...
                    <div class="rounded-lg shadow-sm ring-1 ring-gray-900/5 bg-white">
                        <dl class="flex flex-wrap">
                            ...
                            <div class="mt-6 flex w-full flex-none gap-x-4 border-t border-gray-900/5 px-6 pt-6">
                                ...
                                <dd class="text-base font-bold leading-6 text-gray-900">{{ $property->address }}
                                </dd>
                            </div>
                        ...
                        <div class="mt-6 border-t border-gray-900/5 pb-0">
                            ...
                            <div class="space-y-2 px-4" x-data="{ phoneForm: false }" wire:sortable="orderPhone">
                                ...
                                <div class="relative z-10" aria-labelledby="modal-title" role="dialog"
                                    aria-modal="true" x-show="phoneForm" x-transition:enter="ease-out duration-300"
                                    ...
                                    x-on:close-phone-form.window="phoneForm = false" wire:keydown.enter="savePhone"
                                    x-cloak>
                                                            ...
                                                            <div class="mt-2 space-y-1">
                                                                <div class="flex items-center gap-x-3">
                                                                    <input id="phoneTypeForm"
                                                                        wire:model="phoneTypeForm" type="radio"
                                                                        value="0"
                        ...
                        <div class="mt-3 border-t border-gray-900/5 pb-4">
                            <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                                ...
                                <dd class="text-sm font-medium leading-6 text-gray-500">{{ $property->documentation }}
                                </dd>
                            </div>
                            <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
                                <dt class="flex-none">
                    ...
                    <ul role="list" class="mt-6 space-y-6">
                        <li class="relative flex gap-x-4">
                            ...
                            <p class="flex-auto py-0.5 text-xs leading-5 text-gray-500"><span
                                    class="font-medium text-gray-900">Stephanie Gonzalez</span> creo una visita.</p>
                        ...
                        <li class="relative flex gap-x-4">
                            ...
                            <p class="flex-auto py-0.5 text-xs leading-5 text-gray-500"><span
                                    class="font-medium text-gray-900">Carlos Ybañez</span> envío una factura.</p>
                            ...
                            <div class="flex-auto rounded-md p-3 ring-1 ring-inset ring-gray-200 bg-white">
                                <div class="flex justify-between gap-x-4">
                                    <div class="py-0.5 text-xs leading-5 text-gray-500"><span
                                            class="font-medium text-gray-900">Emanuel Sánchez</span> escribió un
                                        comentario</div>
                                    <time datetime="2023-01-23T15:56"
                                        class="flex-none py-0.5 text-xs leading-5 text-gray-500">hace 6d</time>
                                </div>
                                <p class="text-sm leading-6 text-gray-500">El cliente se encuentra en el exterior, se
                        ...
                        <li class="relative flex gap-x-4">
                            ...
                            <p class="flex-auto py-0.5 text-xs leading-5 text-gray-500"><span
                                    class="font-medium text-gray-900">Stephanie Gonzalez</span> envío una factura.</p>

                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div class="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                                ...
                                <div class="" role="none">
                                    ...
                                    <a wire:navigate href="{{ route('panel.routes.daily', ['year' =>  \Carbon\Carbon::now()->year, 'month' => \Carbon\Carbon::now()->month, 'day' => \Carbon\Carbon::now()->day ]) }}"  class="block px-4 py-2 text-sm bg-gray-100 text-gray-900" role="menuitem"
                                        tabindex="-1" id="menu-item-0">Vista diaria</a>
                                    <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                        tabindex="-1" id="menu-item-1">Vista semanal</a>
                                    <a wire:navigate href="{{ route('panel.routes.monthly', ['year' =>  \Carbon\Carbon::now()->year, 'month' => str_pad( \Carbon\Carbon::now()->month, 2, '0', STR_PAD_LEFT) ]) }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
...
{{--
    ...
    <div class="mx-auto max-w-screen-2xl md:px-6 lg:px-8">
        ...
        <div class="mt-8 flow-root">
            <livewire:panel.routes.partials.unassigned-visits :year="$year" :month="$month" :day="$day" />

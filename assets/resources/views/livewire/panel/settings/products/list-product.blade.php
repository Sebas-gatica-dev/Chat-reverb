<div>
    <div class="mx-auto max-w-screen-2xl pt-2 lg:flex lg:gap-x-16 lg:px-8">
        <h1 class="sr-only">Configuracion de Productos</h1>
            ...
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                ...
                <div class="sm:flex sm:items-center" x-data="{ open: false }">
                    <div class="sm:flex-auto">
                        ...
                        <p class="mt-2 text-sm text-gray-700">Administa los productos de tu inventario</p>
                    </div>
                ...
                <div class="mt-8 flow-root">
                    <div
                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-4">
                            @if(auth()->user()->business->warehouses->count() > 0 && $products->count() > 0)
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col"
                                            ...
                                            Nombre</th>
                                        <th scope="col"
                                            class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Tag
                                        </th>
                                        <th scope="col"
                                        ...
                                        <th scope="col" class="relative py-3.5 pl-3 pr-16 sm:pr-11">
                                            ...
                                            <svg wire:loading.inline wire:target="restoreProduct, forceDeleteProduct, deleteProduct" class="absolute right-1 hidden animate-spin mx-4 h-5 w-5 text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                ...
                                                <td
                                                    class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                                        ...
                                                        @can('access-function', 'stock-product-edit')
                                                            <a wire:navigate
                                                                href="{{ route('panel.settings.stock.product.edit', $product->id) }}"
                        ...
                        @elseif(auth()->user()->business->warehouses->count() == 0)

                        <div class="rounded-md bg-yellow-50 p-4 my-6">
                            <div class="text-sm font-medium text-yellow-700 text-center">
                                <p>Debes registrar un deposito antes de crear productos.</p><a class="text-indigo-600 " wire:navigation href="{{ route('panel.settings.stock.warehouse.list' ) }}" >Agrega un deposito.</a>
                            </div>
                        </div>
                        ...
                        @elseif($products->count() == 0)
                            ...
                            <div class="rounded-md bg-yellow-50 p-4 my-6">
                                <div class="text-sm font-medium text-yellow-700 text-center">
                                    <p>No posees productos creados.</p><a class="text-indigo-600 " wire:navigation href="{{ route('panel.settings.stock.product.create' ) }}" >Agrega un producto.</a>
                                </div>
                            </div>

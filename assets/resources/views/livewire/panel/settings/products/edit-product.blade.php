                    ...
                    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-3">
                        ...
                        <div x-data="{
                            ...
                            radioGroupOptions: [
                                {
                                    title: 'Un solo uso',
                                    description: 'Producto que será usado y descartado',
                                    value: 'SINGLE_USE'
                                },
                                {
                                    title: 'Administrable',
                                    description: 'Insumo que contiene una cantidad de unidades o medidas, y se gestiona su cantidad progresivamente, hasta ser descartado',
                                    value: 'MULTIPLE_USE'
                                },
                                {
                                    title: 'Por tiempo',
                                    description: 'Insumo que se utiliza una determinada cantidad de veces, u horas',
                                    value: 'TIME_USE'
                                },
                            ]
                            ...
                            <div class="w-[1100px] mx-auto space-y-3 px-4"> <!-- Contenedor centrado -->
                                <template x-for="(option, index) in radioGroupOptions" :key="index">
                                    <label @click="radioGroupSelectedValue = option.value" class="flex items-start p-5 space-x-3 bg-white border rounded-md shadow-sm hover:bg-gray-50 border-neutral-200/70">
                                        <input type="radio" name="radio-group" :value="option.value" x-bind:checked="radioGroupSelectedValue === option.value" class="text-indigo-600 translate-y-px focus:ring-indigo-600" />

                                        ...
                                        <div wire:key="{{ $product->id }}">
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    @if ($product->deleted_at)
                                                        @can('access-function', 'stock-product-delete')
                                                            <button wire:click="forceDeleteProduct('{{ $product->id }}')"
                                                                wire:confirm="¿Estás seguro de que deseas eliminar definitivamente este producto?"
                                                                class="text-red-600 hover:text-red-900 ml-4">Eliminar</button>
                                                        @endcan
                                                        @can('access-function', 'stock-product-restore')

<div>
    <div x-data="{ open: @entangle('open').live }" @keydown.window.escape="open = false" x-init="$watch( & quot; open & quot;, o => !o & amp; & amp; window.setTimeout(() => (open = true), 1000))" x-show="open"
        class="relative z-10" aria-labelledby="modal-title" x-ref="dialog" aria-modal="true">

        <div x-show="open" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-cloak
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div x-show="open" x-transition:enter="ease-out duration-300" x-cloak
                    ...
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                        ...
                        <button type="button" wire:click="confirm"
                            ...
                            @click="open = false">Continuar</button>
                    </div>
                </div>

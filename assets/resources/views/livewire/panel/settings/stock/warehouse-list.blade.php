                                      ...
                                      <div wire:key="{{ $warehouse->id }}">
                                          <tr>
                                              ...
                                              <td
                                                  ...
                                                  @if ($warehouse->deleted_at)
                                                      @can('access-function', 'stock-warehouse-delete')
                                                          <button wire:click="forceDeleteWarehouse('{{ $warehouse->id }}')"
                                                      ...
                                                      @endcan
                                                      @can('access-function', 'stock-warehouse-restore')
                                                          <button wire:click="restoreWarehouse('{{ $warehouse->id }}')"

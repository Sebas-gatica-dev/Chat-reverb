                        ...
                        <div class="px-4 py-6 sm:p-8">
                         ...
                         x-data="{ operator: @entangle('operator').live }">
                                    ...
                                    <!-- Campos 'min', 'max', 'default_quantity' -->
                                        {{-- @dump('hola') --}}
                                        <div class="col-span-full grid grid-cols-1 sm:grid-cols-2 gap-4" x-show="!(operator === 'FIXED') && (operator != '') " >
                                            <!-- Valor Mínimo -->
                                            <div>
                                                <label for="min"
                                            ...
                                            <div class="col-span-full sm:col-span-2">
                                                ...
                                                <div class="mt-2">
                                                    <input type="number" step="1" :class="{ 'disabled': $wire }"
                                                        wire:model.live.debounce.1000ms="default_quantity" id="default_quantity"
                                                        autocomplete="off"

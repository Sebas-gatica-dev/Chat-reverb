<div>
    ...
    <div class="mx-auto max-w-screen-2xl pt-2 lg:flex lg:gap-x-16 lg:px-8">
        <h1 class="sr-only">Crear nueva cuenta</h1>
            ...
            <div class="mx-auto max-w-2xl space-y-16 sm:space-y-20 lg:mx-0 lg:max-w-none">
                ...
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Nueva cuenta bancaria</h1>
                        <p class="mt-2 text-sm text-gray-700">Registra una nueva cuenta para tu negocio
                        </p>
                    </div>
                    ...
                    <x-panel.settings.form>
                        ...
                        <x-slot name="slot">
                             ...
                             <div class="lg:col-span-3 col-span-full">
                                ...
                                <div class="mt-2">
                                    <input type="text" wire:model="name" name="name" id="name"
                                        autocomplete="off" placeholder="Ej: Juan Hernán Pérez"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm sm:leading-6">
                                </div>
                                @error('name')
                                    <span class="text-red-500 text-sm ml-0.5">{{ $message }}</span>
                           ...
                           {{-- ENTIDAD BANCARIA --}}
                            <div class="lg:col-span-3 col-span-full">
                                <label for="address"
                                    class="block text-sm font-medium leading-6 text-gray-900">Entidad Bancaria</label>
                                <div class="mt-2">
                            ...
                            <div class="lg:col-span-3 col-span-full">
                                <label for="branches"
                                    class="block text-sm font-medium leading-6 text-gray-900">Selecciona sucursales para tu cuenta </label>
                                    <div class="mt-2">
                                        <livewire:components.multi-select-general :selectedValues="$selectedBranches" :values="$branches"
                                            :imageValue="false" :searchEnabled="true" :name="'branches'"
                                            :model="false">
                                    </div>
                            ...
                            <div class="lg:col-span-3 col-span-full">
                                ...
                                <div class="mt-2">
                                    <input type="text" wire:model="cuit" name="cuit" id="cuit"
                                        autocomplete="off" placeholder="Entre 8 y 11 caracteres numericos..."
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="lg:col-span-3 col-span-full">
                                <label for="address"
                                    class="block text-sm font-medium leading-6 text-gray-900">Numero de cuenta</label>
                                <div class="mt-2">
                                    <input type="text" wire:model="account_number" name="account_number" id="account_number"
                                        autocomplete="off" placeholder="Ej: 204-87865/8"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm sm:leading-6">
                                </div>
                            ...
                            <div class="lg:col-span-3 col-span-full">
                                ...
                                <div class="mt-2">
                                    <input type="text" wire:model="cbu" name="cbu" id="cbu"

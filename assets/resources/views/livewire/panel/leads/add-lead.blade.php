                ...
                <div class="space-y-10 divide-y divide-gray-900/10">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-4">
                        <div class="px-4 sm:px-0">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">Ingresa los datos del lead para
                                poder tener su información en el sistema.</p>
                        </div>
                                ...
                                <div class="grid w-full grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-9">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="created_by"
                                            class="block text-sm font-medium leading-6 text-gray-900">Creado
                                            por</label>
                                        <div class="mt-2">
